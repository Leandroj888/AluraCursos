...
class ListaDeFormacoes implements RequestHandlerInterface
{
    ...
    private EntityRepository $formacaoRepository;

    public function __construct(EntityManagerInterface $entityManager)
    {
        $this->formacaoRepository = $entityManager->getRepository(Formacao::class);
    }

    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        $formacoes = $this->formacaoRepository->findBy($request->getQueryParams(), ['descricao' => 'ASC']);
