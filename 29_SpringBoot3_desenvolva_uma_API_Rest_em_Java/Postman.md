...
GET: http://localhost:8080/pacientes?page=2&size=1
GET: http://localhost:8080/pacientes?sort=nome
GET: http://localhost:8080/pacientes?sort=nome,desc


## Excluir
DELETE: http://localhost:8080/pacientes/9