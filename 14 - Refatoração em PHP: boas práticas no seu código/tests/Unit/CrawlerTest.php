...
class CrawlerTest extends TestCase
{
    ...
    public function testTryingToParseInvalidHtmlMustThrowException()
    {
        ...
        $factoryMock = $this->createStub(GoogleProxyAbstractFactory::class);
        $factoryMock->method('createGoogleHttpClient')->willReturn($googleHttpClient);
        $crawler = new Crawler($factoryMock);
