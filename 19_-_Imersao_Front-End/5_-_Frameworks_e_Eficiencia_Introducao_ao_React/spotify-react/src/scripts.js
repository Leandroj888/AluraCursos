...
function requestApi(searchTerm) {
    const url = `http://localhost:3001/artists?name_like=${searchTerm}`; //query string para esse ?name_like é apenas para já filtrar resultado no json, provável seja implementação do json_server
